...
function SYN:SwapGroups(l, r)
    ...
    if li and ri then
        SwapRaidSubgroup(li, ri)
        print(SYN:strconcat('swapped ', l, ' and ', r))
    else
        print(SYN:strconcat('could not find: ', li and l or '', ri and r or ''))
    end
end
...
SlashCmdList.SYNLOOT = function(input)
    ...
    elseif bits[1] == 'gp' then
        SYN_PRINT_TYPE = 'gp'
    elseif bits[1] == 'swap' then
        SYN:SwapGroups(bits[2], bits[3])
        return
